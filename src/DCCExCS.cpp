...
void DCCExCS::writeLocoAddress(uint16_t address) {
  _response = {
    "w (-?\\d+)",
...
void DCCExCS::writeLocoCVByte(uint16_t cv, uint8_t value) {
  _response = {
    "r (\\d+) (-?\\d+)",
...
void DCCExCS::readLocoCVByte(uint16_t cv) {
  _response = {
    "r12345\\|32767\\|(\\d+) (-?\\d+)",
...
void DCCExCS::writeLocoCVBit(uint16_t cv, uint8_t bit, bool value) {
  _response = {
    "r12345\\|32767\\|(\\d+) (\\d+) (-?\\d+)",
